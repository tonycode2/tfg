...
export const InicioView = memo(function InicioView({ userRole }: InicioViewProps) {
  // Memoize stats based on user role to avoid recalculation on every render
  const stats = useMemo(() => getStatsForRole(userRole), [userRole]);
...
// Extract stats generation function outside component for better organization
function getStatsForRole(userRole: Role) {
