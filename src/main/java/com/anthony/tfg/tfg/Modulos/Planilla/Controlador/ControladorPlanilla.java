...
public class ControladorPlanilla {
    ...
    @GetMapping
    public ResponseEntity<Page<RespuestaPlanillaEncabezadoDTO>> obtenerTodos(Pageable pageable) {
        Page<RespuestaPlanillaEncabezadoDTO> page = servicio.obtenerTodos(pageable);
