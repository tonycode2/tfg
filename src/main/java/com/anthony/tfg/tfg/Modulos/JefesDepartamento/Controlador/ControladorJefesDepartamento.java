...
public class ControladorJefesDepartamento {
    ...
    @GetMapping
    public ResponseEntity<Page<RespuestaJefesDepartamentoDTO>> obtenerTodos(Pageable pageable) {
        Page<RespuestaJefesDepartamentoDTO> page = servicio.obtenerTodos(pageable);
